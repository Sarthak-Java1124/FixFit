...
const cardVariants = {
  ...
  animate: { opacity: 1, scale: 1, transition: { duration: 0.7, ease: "easeOut" as const } },
  hover: { scale: 1.02, boxShadow: "0 0 32px #ff9900aa" },
};
const leftTextVariants = {
  initial: { opacity: 0, y: 20 },
  animate: { opacity: 1, y: 0, transition: { duration: 0.8, delay: 0.3, ease: "easeOut" as const } },
  float: { y: [0, -10, 0, 10, 0], transition: { repeat: Infinity, duration: 6, ease: "easeInOut" as const } },
};
const formStagger = {
        ...
        >
          ...
          >
            <AnimatePresence mode="wait">
              ...
              >
                Create your account to start shopping and booking tailoring services.
              </motion.p>
              <motion.form
                key="form"
